...
def login():
    if request.method == 'POST':
        ...
        if user:
            ...
            os.system(f"sudo iptables -I FORWARD -i wlan0 -s {ip} -j ACCEPT")
...
def logout():
    ...
    # Use the os.system module to run the iptables command
    os.system(f"sudo iptables -D FORWARD -i wlan0 -s {ip} -j ACCEPT")
